...
const POSchema = new Schema({
  ...
  totalValue:  Number,
  status:      { type: String, enum: ["Approved","Cancelled","Pending","Pending GRN","Pending L1","Pending L2","Pending L3","Fulfilled","Blocked","Draft","GRN Pending","GRN Fulfilled","GRN Variance","Ready for Payment","PO Closed","On Hold","Pending Revision"], default: "Draft" },
