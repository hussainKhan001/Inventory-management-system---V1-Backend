...
const SettingsSchema = new Schema({
  ...
  approvers: {
    ...
    l1SlackId:        { type: String, default: "" },
    l1SlackChannelId: { type: String, default: "" },
    l2:               { type: String, default: "Jinesh Jain" },
    l2Id:             { type: String, default: "" },
    l2Title:          { type: String, default: "" },
    l2SlackId:        { type: String, default: "" },
    l2SlackChannelId: { type: String, default: "" },
    l3:               { type: String, default: "Rahul Gupta" },
    l3Id:             { type: String, default: "" },
    l3Title:          { type: String, default: "" },
    l3SlackId:        { type: String, default: "" },
    l3SlackChannelId: { type: String, default: "" },
  },
  bypassApprovals: {
  ...
  companyApprovers: [{
    ...
    l1: { type: String, default: "" }, l1Id: { type: String, default: "" }, l1Title: { type: String, default: "" }, l1SlackId: { type: String, default: "" }, l1SlackChannelId: { type: String, default: "" },
    l2: { type: String, default: "" }, l2Id: { type: String, default: "" }, l2Title: { type: String, default: "" }, l2SlackId: { type: String, default: "" }, l2SlackChannelId: { type: String, default: "" },
    l3: { type: String, default: "" }, l3Id: { type: String, default: "" }, l3Title: { type: String, default: "" }, l3SlackId: { type: String, default: "" }, l3SlackChannelId: { type: String, default: "" },
    bypassL1: { type: Boolean, default: false },
    bypassL2: { type: Boolean, default: false },
    bypassL3: { type: Boolean, default: false },
  }],
