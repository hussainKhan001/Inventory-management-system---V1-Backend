  ...
  try {
    ...
    try {
      ...
      const allPerms = [
        ...
        "VIEW_RECYCLE_BIN_QUOTATION",
        "RESTORE_QUOTATION",
        "VIEW_RECYCLE_BIN_SUPPLIER",
        "RESTORE_SUPPLIER",
        "VIEW_RECYCLE_BIN_CATALOGUE",
        "RESTORE_CATALOGUE",
        "VIEW_RECYCLE_BIN_INVENTORY",
        "RESTORE_INVENTORY",
        "VIEW_RECYCLE_BIN_MATERIAL_PLAN",
        "RESTORE_MATERIAL_PLAN",
        "VIEW_RECYCLE_BIN_EMR",
        "RESTORE_EMR",
        "VIEW_RECYCLE_BIN_WRITE_OFF",
        "RESTORE_WRITE_OFF",
        "VIEW_RECYCLE_BIN_MASTER_PO",
        "RESTORE_MASTER_PO",
        "VIEW_RECYCLE_BIN_GRN",
        "RESTORE_GRN",
        "VIEW_RECYCLE_BIN_INWARD",
        "RESTORE_INWARD",
        "VIEW_RECYCLE_BIN_OUTWARD",
        "RESTORE_OUTWARD",
        "VIEW_RECYCLE_BIN_INWARD_RETURN",
        "RESTORE_INWARD_RETURN",
        "VIEW_RECYCLE_BIN_OUTWARD_RETURN",
        "RESTORE_OUTWARD_RETURN"
      ];
